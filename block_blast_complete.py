#!/usr/bin/env python3
"""
BLOCK BLAST - Version Ultra-Fidèle
Reproduction exacte du jeu mobile Block Blast
"""
...
# ============================================================================
# CONSTANTES - COULEURS EXACTES DU JEU
# ============================================================================

# Couleurs principales
BG_COLOR = (59, 89, 152)  # Bleu du fond
GRID_BG = (28, 42, 70)    # Fond grille plus foncé
GRID_LINE = (45, 65, 105)  # Lignes de grille
EMPTY_CELL = (35, 50, 85)  # Case vide

# Couleurs des blocs avec effet 3D (top, main, shadow)
BLOCK_COLORS = {
    'yellow': {
        'top': (255, 230, 100),
        'main': (255, 200, 50),
...
BASE_UI_SCALE = 0.85  # Dezoom global des elements
DISPLAY_MARGIN = 80
...
# ============================================================================
# PIÈCES DU JEU - 27 FORMES EXACTES
# ============================================================================
...
class BlockBlastGame:
    ...
    def place_piece(self, piece: Piece, grid_x: int, grid_y: int):
        ...
        # Vérifier les lignes/colonnes complètes
        self.check_and_clear()
        
        return True
    
    def check_and_clear(self):
        """Vérifie et efface les lignes/colonnes complètes"""
        lines_to_clear = []
        cols_to_clear = []
    ...
    def calculate_score(self, piece_size: int, total_clears: int) -> int:
        """Calcule le score selon la formule exacte"""
        if total_clears == 0:
            return piece_size
        elif total_clears == 1:
    ...
    def draw_3d_block(self, x: int, y: int, size: int, color_name: str, alpha: int = 255):
        """Dessine un bloc avec effet 3D (ameliore)"""
        colors = BLOCK_COLORS[color_name]
        radius = 0
        bevel = max(4, size // 7)  # epaisseur des bandes (un peu plus epais)
        ...
        # Lumiere en haut et a gauche (trapezes)
        ...
        # Ombre en bas et a droite (trapezes)
    ...
    def draw_piece_at_pixel(
        ...
        """Dessine une piece a une position pixel"""
        for dx, dy in piece.shape:
    ...
    def draw_piece_on_grid(self, piece: Piece, grid_x: int, grid_y: int, alpha: int, invalid: bool):
        """Dessine une piece alignee sur la grille"""
    ...
    def draw_floating_piece(self):
        """Dessine la piece selectionnee en mouvement (suivi souris)"""
    ...
    def draw_pieces_panel(self):
        """Dessine les 3 pièces disponibles"""
    ...
    def draw_ui(self):
        ...
        # Score principal avec effet cœur
        ...
        # Best score (petit, en haut a gauche, au-dessus du score)
    ...
    def handle_click(self, pos):
            ...
            if self.selected_piece_idx is not None:
                ...
                if piece:
                    ...
                    if self.place_piece(piece, grid_x, grid_y):
                        ...
                        # Vérifier si toutes les pièces sont utilisées
        ...
        # Clic ailleurs = annuler selection
        if self.selected_piece_idx is not None:
            self.selected_piece_idx = None
    ...
    def update_hover(self, pos):
        """Met à jour la position de hover"""
        x, y = pos
